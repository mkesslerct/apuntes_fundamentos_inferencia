...
Consideremos dos variables aleatorias normales $X$ e $Y$ con varianzas $\sigma_2^X$ y $\sigma_2^Y$, así como $X_1, \ldots, X_{n_X}$ y $Y_1, \ldots, Y_{n_Y}$ dos muestras aleatorias simples de $X$ y $Y$ respectivamente. Una consecuencia de la @prp-F-Snedecor es que
